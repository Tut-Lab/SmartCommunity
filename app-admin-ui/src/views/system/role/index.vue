  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="所属应用" prop="appId">
        <el-select v-model="form.appId" disabled placeholder="所属应用" clearable size="small">
          <el-option
            v-for="app in appOptions"
            :key="app.appId"
            :label="app.appName"
...
export default {
  ...
  methods: {
    ...
    getMenuTreeselect(id) {
      menuTreeselect({'appId': id}).then(response => {
    ...
    getRoleMenuTreeselect(roleId) {
      return roleMenuTreeselect(roleId, {'appId': this.queryParams.appId}).then(response => {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.roleName + '"角色吗?', "警告", {
    ...
    async handleAdd() {
      ...
      this.reset();
      this.form.appId = this.queryParams.appId;
      await this.getMenuTreeselect(this.queryParams.appId);
      this.open = true;
      this.title = "添加角色";
    },
    /** 修改按钮操作 */
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除角色编号为"' + roleIds + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有角色数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
