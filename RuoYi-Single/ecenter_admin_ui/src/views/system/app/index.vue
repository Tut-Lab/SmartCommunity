...
<script>
import { listApp, getApp, delApp, addApp, updateApp, exportApp } from "@/api/system/app/api.js";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除xx编号为"' + appIds + '"的数据项?', "警告", {
