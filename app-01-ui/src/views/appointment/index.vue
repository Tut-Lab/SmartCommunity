  ...
  <div>
    <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="100px">
      ...
      <el-form-item label="预约事项" prop="content">
        <el-input v-model="formData.content" placeholder="请输入预约事项" clearable :style="{width: '100%'}">
        </el-input>
      </el-form-item>
      <el-form-item label="居住地址" prop="address">
        <el-input v-model="formData.address" placeholder="请输入居住地址" clearable :style="{width: '100%'}">
        </el-input>
      </el-form-item>
